...
<title>{{trans('home.add_installmentPartner')}}</title>
@section('content')
        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.add_installmentPartner')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.add_installmentPartner')}}</h6>
                        </div>
                        {!! Form::open(['route' => 'installmentPartners.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
