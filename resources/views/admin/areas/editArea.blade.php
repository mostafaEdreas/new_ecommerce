                        ...
                        {!! Form::open(['method'=>'PATCH','url' => 'admin/areas/'.$area->id, 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" name="shipping_fees" type="number" min="0" placeholder="{{trans('home.shipping_fees')}}" value="{{$area->shipping_fees}}" >
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="ckbox">
                                        <input name="available_beranche" value="1" {{($area->available_beranche == 1)? 'checked':''}} type="checkbox"><span class="tx-13">{{trans('home.available_beranche')}}</span>
                                    </label>
                                </div>
