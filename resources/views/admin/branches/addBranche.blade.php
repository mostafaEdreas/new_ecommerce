            ...
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'branches.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input class="form-control" name="mobile" type="number" min="0" placeholder="{{trans('home.mobile')}}">
                                </div>
                                
                                <div class="form-group col-md-2">
                                    <label class="">{{trans('home.mobile')}} 2</label>
                                    <input class="form-control" name="mobile2" type="number" min="0" placeholder="{{trans('home.mobile')}} 2">
                                </div>
