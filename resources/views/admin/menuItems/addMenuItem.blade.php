                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control select2 menu_type" name="type" required>
                                                ...
                                                <option value="deals">{{trans('home.deals')}}</option>
                                                <option value="featured">{{trans('home.featured')}}</option>
                                                <option value="category">{{trans('home.category')}}</option>
                                                <option value="categories">{{trans('home.categories')}}</option>
                                                <option value="branches">{{trans('home.branches')}}</option>
                                                <option value="product">{{trans('home.product')}}</option>
                                                <option value="products">{{trans('home.products')}}</option>
                                                <option value="bestSeller">{{trans('home.bestSeller_products')}}</option>
                                                ...
                                                <option value="attribute">{{trans('home.attribute')}}</option>
                                                <option value="pages">{{trans('home.pages')}}</option>
                                                <option value="blogs">{{trans('home.blogs')}}</option>
                                                <option value="blog-category">{{trans('home.blog_category')}}</option>
                                                <option value="blog-item">{{trans('home.blog_item')}}</option>
                                                <option value="galleryImages">{{trans('home.galleryImages')}}</option>
                                                <option value="galleryVideos">{{trans('home.galleryVideos')}}</option>
                                                <option value="inspection-request">{{trans('home.inspection_request')}}</option>
