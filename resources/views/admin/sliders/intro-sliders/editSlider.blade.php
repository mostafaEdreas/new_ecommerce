                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <select class="form-control select2" name="lang" required>
                                        <option value="ar" selected>{{trans('home.arabic')}}</option>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control area1" name="text"  placeholder="{{trans('home.text')}}">{!! $slider->text !!}</textarea>
                                </div>

                                <div class="form-group  col-md-12">
                                    <label>{{trans('home.video')}} (1920px * height auto)</label>
                                    <div class="input-group mb-1">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="inputGroupFile01">{{trans('home.video')}}</label>
                                        </div>
                                    </div>
                                </div>

                                @if($slider->image)
                                <video style="height:150px" src="{{url('/uploads/sliders/intro-sliders/source')}}/{{$slider->image}}">                       
                                    @endif
                            </div>
