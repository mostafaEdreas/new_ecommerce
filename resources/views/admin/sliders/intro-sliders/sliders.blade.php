    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="btn btn-list">
                <a href="{{url('admin/intro-sliders/create')}}"><button class="btn ripple btn-primary">{{trans('home.add')}}</button></a>
                        ...
                        <table class="table" id="exportexample">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p">{{trans('home.video')}}</th>
                                    ...
                                    <tr id="{{$slider->id}}">
                                        ...
                                        <td>
                                            <a href="{{ route('intro-sliders.edit', $slider->id) }}">
                                                @if($slider->image)
                                                    <video style="height:45px" src="{{url('/uploads/sliders/intro-sliders/source')}}/{{$slider->image}}">
