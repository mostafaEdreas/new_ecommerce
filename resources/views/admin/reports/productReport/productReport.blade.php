...
<title>{{trans('home.product_report')}}</title>
@section('content')
...
<div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">{{trans('home.product_report')}}</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/admin')}}">{{trans('home.admin')}}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.product_report')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <h6 class="card-title mb-1">{{trans('home.product_report')}}</h6>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="brands">{{trans('home.product')}}</label>
   ...
   $( function() {
    ...
    $('.search').on('click',function(){
        ...
        if(dateFrom && dateTo && productId){
            ...
            $.ajax({
                url:" {{url('admin/product-report')}}",
                method:'POST',
                data:{productId:productId,dateFrom:dateFrom,dateTo:dateTo},
