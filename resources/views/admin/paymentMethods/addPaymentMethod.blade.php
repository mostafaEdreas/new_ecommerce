...
<title>{{trans('home.add_paymentMethod')}}</title>
@section('content')
        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('home.add_paymentMethod')}}</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">{{trans('home.add_paymentMethod')}}</h6>
                        </div>
                        {!! Form::open(['route' => 'payment-methods.store', 'data-toggle'=>'validator', 'files'=>'true']) !!}
                            <div class="row">
