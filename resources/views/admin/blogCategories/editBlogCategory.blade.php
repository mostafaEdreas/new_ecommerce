                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" name="meta_title_en" placeholder="{{trans('home.meta_title')}}">{{$blogCategory->meta_title_en}}</textarea>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="meta_desc"> {{trans('home.meta_desc')}}</label>
                                            <textarea class="form-control" name="meta_desc_en" placeholder="{{trans('home.meta_desc')}}">{{$blogCategory->meta_desc_en}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="meta_title"> {{trans('home.meta_title')}}</label>
                                            <textarea class="form-control" name="meta_title_ar" placeholder="{{trans('home.meta_title')}}">{{$blogCategory->meta_title_ar}}</textarea>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="meta_desc"> {{trans('home.meta_desc')}}</label>
                                            <textarea class="form-control" name="meta_desc_ar" placeholder="{{trans('home.meta_desc')}}">{{$blogCategory->meta_desc_ar}}</textarea>
                                        </div>


                                        <div class="form-group col-md-12">
                                            <label class="ckbox">
                                                <input name="meta_robots" value="1" {{($blogCategory->meta_robots == 1)? 'checked':''}} type="checkbox"><span class="tx-13">{{trans('home.meta_robots')}} (index)</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                     ...
                                     @if($blogCategory->image)
                                        <div class="col-md-12">
                                            <img src="{{url('\uploads\blogitems\source')}}\{{$blogCategory->image}}" width="200" height="150">
                                        </div>
                                    @endif
                                </div>
