 ...
 <!-- Brands Section Start  -->
   <section class="pt-0">
      <div class="container-lg">
        <div class="title-box">
          <h2 class="unique-heading">{{__('home.Our Brands')}} </h2>
        ...
        <div class="catagories-style-6 customed">
          <div class="swiper home-catagories-slider2 swiper-initialized swiper-horizontal swiper-pointer-events">
            <div class="swiper-wrapper" id="swiper-wrapper-65253c3867681993" aria-live="polite"
              style="transition-duration: 0ms; transform: translate3d(-442px, 0px, 0px);">
            @foreach($brands as $brand )
            <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 6" style="width: 211px; margin-right: 10px;">
                <a href="{{url('searchResult/?search_input='.$brand->{'name_'.$lang} )}}" class="catagories-box">
                  <div class="img-box">
                  <img src="{{Helper::uploadedImagesPath('brands',$brand->logo)}}" alt="{{$brand->{'name_'.$lang} }}">
                  </div>
                  <h3>{{$brand->{'name_'.$lang} }}</h3>
                </a>
              </div>
            @endforeach
            </div>
