      ...
      <div class="container-lg">
        <div class="breadcrumb-box">
          ...
          <ol class="breadcrumb">
            ...
            <li class="current"><a >{{__('home.search_results')}}</a></li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="row gy-4 gy-lg-5 gx-0">
                ...
                <div class="sidebar-inner sticky">
                    ...
                    <div class="row gy-3 gx-0 g-lg-4">
                        ...
                        <div class="col-lg-12">
                            <div class="sidebar-box">
                                <div class="title-box4">
                                    <h4 class="heading">{{__('home.filter')}} <span class="bg-theme-blue"></span></h4>
                                </div>
                                    <!--Prices-->
                            ...
                            <div class="sidebar-box">
                            <div class="title-box4">
                                <h4 class="heading">{{__('home.brand')}} <span class="bg-theme-blue"></span></h4>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="sidebar-box">
                            <div class="title-box4">
                                <h4 class="heading">{{__('home.power')}} <span class="bg-theme-blue"></span></h4>
                            </div>
                            <ul class="catagories-side">
                ...
                <div class="shop-product">
                    <div class="top-header-wrap">
                        <a href="javascript:void(0)" class="filter-btn btn-solid btn-sm mb-line me-4">{{__('home.filter')}} <i class="arrow"></i></a>
                            <!--Brands &&& Sorting-->
                            ...
                            <div class="select-options">
                                <div class="select-menu">
                                    ...
                                    <div class="dropdown select-dropdown">
                                        <button class="select-showval" id="sortProduct">{{__('home.sort_by')}}<i data-feather="chevron-down"></i></button>
                                    ...
                                    <div class="dropdown select-dropdown small-dropdown">
                                        <button class="select-showval" id="featureProduct"><span>{{__('home.brand')}}</span> <i
