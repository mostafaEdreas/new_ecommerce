        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                    <div class="page-title"><h1>{{$brand->{'name_'.$lang} }}</h1></div>
                    <!--Breadcrumbs-->
                    <div class="breadcrumbs">
                        <span class="main-title fw-bold">{{__('home.brands')}}</span>
                        <a href="{{LaravelLocalization::localizeUrl('/')}}" title="Back to the home page"><i class="icon anm anm-angle-right-l"></i>{{trans('home.home')}}</a>
                    </div>
                    <!--End Breadcrumbs-->
                </div>
            </div>
                ...
                <div class="toolbar toolbar-wrapper shop-toolbar">
                    <div class="row align-items-center">
                        <div class="col-4 col-sm-2 col-md-4 col-lg-4 text-left filters-toolbar-item d-flex order-1 order-sm-0">
                            {{--                    <button type="button" class="btn btn-filter text icon anm anm-sliders-hr d-inline-flex ms-2 ms-lg-3">{{__('home.sort_by')}}</button>--}}
