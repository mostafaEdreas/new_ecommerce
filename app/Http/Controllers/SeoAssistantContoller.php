...
class SeoAssistantContoller extends Controller
{
    ...
    public function update(Request $request, $id){
        ...
        $add->featuredProducts_meta_title = $request->featuredProducts_meta_title ; 
        $add->featuredProducts_meta_desc = $request->featuredProducts_meta_desc ; 
        $add->featuredProducts_meta_title_ar = $request->featuredProducts_meta_title_ar ; 
        $add->featuredProducts_meta_desc_ar = $request->featuredProducts_meta_desc_ar ;
        $add->featuredProducts_meta_robots = $request->featuredProducts_meta_robots ; 
        ...
        $add->branches_meta_title = $request->branches_meta_title;
        $add->branches_meta_desc = $request->branches_meta_desc;
        $add->branches_meta_title_ar = $request->branches_meta_title_ar;
        $add->branches_meta_desc_ar = $request->branches_meta_desc_ar;
        $add->branches_meta_robots = $request->branches_meta_robots;
        
        $add->inspectionRequest_meta_title = $request->inspectionRequest_meta_title;
        $add->inspectionRequest_meta_desc = $request->inspectionRequest_meta_desc;
        $add->inspectionRequest_meta_title_ar = $request->inspectionRequest_meta_title_ar;
        $add->inspectionRequest_meta_desc_ar = $request->inspectionRequest_meta_desc_ar;
        $add->inspectionRequest_meta_robots = $request->inspectionRequest_meta_robots;
