...
trait SeoTrait {
    ...
    public function homePageSeo(){
        ...
        $schema1 = new Thing('LocalBusiness', [
            ...
            'image'         => url("uploads/settings/source/$configration->app_logo")?url("uploads/settings/source/$configration->app_logo"):'no logo available',
            'telephone' => $setting->mobile,
            'address' => $configration->address1?$configration->address1:'no address found !',
        ]);


        $schema2= new Thing('Organization', [
            'url'          => \LaravelLocalization::localizeUrl('/'),
            'logo'         => url("uploads/settings/source/$configration->app_logo")?url("uploads/settings/source/$configration->app_logo"):'no logo available',
    ...
    public function aboutUsPageSeo(){
        ...
        $metatags = new MetaTags();
        $metatags
                ->title(($seo->about_meta_title || $seo->about_meta_title_ar)? (($lang == 'en')?$seo->about_meta_title:$seo->about_meta_title_ar):$configration->app_name)
                ->meta('title',($seo->about_meta_title || $seo->about_meta_title_ar)? (($lang == 'en')?$seo->about_meta_title:$seo->about_meta_title_ar):$configration->app_name)
                ->description(($seo->about_meta_desc || $seo->about_meta_desc_ar)?(($lang == 'en')?$seo->about_meta_desc:$seo->about_meta_desc_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
        ...
        $schema = new Schema(
            new Thing('Article', [
                ...
                'image'=> url("uploads/settings/source/$configration->app_logo"),
                'headline'=> (($seo->about_meta_title || $seo->about_meta_title_ar)? (($lang == 'en')?$seo->about_meta_title:$seo->about_meta_title_ar):$configration->app_name),
    ...
    public function contactUsPageSeo(){
        ...
        $schema = new Schema(
            new Thing('Article', [
                ...
                'image'=> url("uploads/settings/source/$configration->app_logo"),
                'headline'=> (($seo->contact_meta_title || $seo->contact_meta_title_ar)? (($lang == 'en')?$seo->contact_meta_title:$seo->contact_meta_title_ar):$configration->app_name),
                'author' => new Thing('author', [
                    'name'=>$configration->app_name,
                    'url'=> \LaravelLocalization::localizeUrl("/contact-us"),
                ]),
    ...
    public function dealsPageSeo(){
        ...
        $metatags
                ->title(($seo->dealsProducts_meta_title || $seo->dealsProducts_meta_title_ar)? (($lang == 'en')?$seo->dealsProducts_meta_title:$seo->dealsProducts_meta_title_ar):$configration->app_name)
                ->meta('title',($seo->dealsProducts_meta_title || $seo->dealsProducts_meta_title_ar)? (($lang == 'en')?$seo->dealsProducts_meta_title:$seo->dealsProducts_meta_title_ar):$configration->app_name)
                ->description(($seo->dealsProducts_meta_desc || $seo->dealsProducts_meta_desc_ar)?(($lang == 'en')?$seo->dealsProducts_meta_desc:$seo->dealsProducts_meta_desc_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
        ...
        $schema = new Schema(
            new Thing('Article', [
                ...
                'image'=> url("uploads/settings/source/$configration->app_logo"),
                'headline'=> ($seo->dealsProducts_meta_title)?$seo->dealsProducts_meta_title:$configration->app_name,
                'author' => new Thing('author', [
                    'name'=>$configration->app_name,
                    'url'=> \LaravelLocalization::localizeUrl("/deals"),
                ]),
    ...
    public function featuredPageSeo(){
        $lang=\LaravelLocalization::getCurrentLocale();
        $configration = Configration::where('lang',$lang)->first();
        $setting = Setting::first();
        $seo = SeoAssistant::first();
        ...
        $metatags
                ->title(($seo->featuredProducts_meta_title || $seo->featuredProducts_meta_title_ar)? (($lang == 'en')?$seo->featuredProducts_meta_title:$seo->featuredProducts_meta_title_ar):$configration->app_name)
                ->meta('title',($seo->featuredProducts_meta_title || $seo->featuredProducts_meta_title_ar)? (($lang == 'en')?$seo->featuredProducts_meta_title:$seo->featuredProducts_meta_title_ar):$configration->app_name)
                ->description(($seo->dealsProducts_meta_desc || $seo->featuredProducts_meta_desc_ar)?(($lang == 'en')?$seo->featuredProducts_meta_desc:$seo->featuredProducts_meta_desc_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
                ->mobile(\LaravelLocalization::getLocalizedURL($lang, null, [], true) )
                ->canonical(\LaravelLocalization::getLocalizedURL($lang, null, [], true) )
        ...
        $schema = new Schema(
            new Thing('Article', [
                'url'=> \LaravelLocalization::localizeUrl("/featured"),
                'image'=> url("uploads/settings/source/$configration->app_logo"),
                'headline'=> ($seo->featuredProducts_meta_title)?$seo->featuredProducts_meta_title:$configration->app_name,
                'author' => new Thing('author', [
                    'name'=>$configration->app_name,
                    'url'=> \LaravelLocalization::localizeUrl("/featured"),
                ]),
    ...
    public function productPageSeo($id){
        ...
        $schema3 = new Thing('ItemPage', [
            ...
            'name'=>($lang == 'en')?$product->name_en:$product->name_ar,
            'url'=> ($lang == 'en')?\LaravelLocalization::localizeUrl("product/$product->link_en"):\LaravelLocalization::localizeUrl("product/$product->link_ar"),
            'primaryImageOfPage'=> url("uploads/settings/source/$configration->app_logo"),
    ...
    public function pageSeo($link){
        ...
        $schema = new Schema(
            new Thing('Article', [
                ...
                'image'=> url("uploads/settings/source/$configration->app_logo"),
                'headline'=> ($seo->about_meta_title)?$seo->about_meta_title:$configration->app_name,
                'author' => new Thing('author', [
                    'name'=>$configration->app_name,
                    'url'=> \LaravelLocalization::localizeUrl("/bout-us"),
                ]),
    ...
    public function brandsPageSeo(){
        ...
        $schema = new Schema(
            new Thing('Article', [
                ...
                'image'=> url("uploads/settings/source/$configration->app_logo"),
                'headline'=> (($seo->brands_meta_title || $seo->brands_meta_title_ar)? (($lang == 'en')?$seo->brands_meta_title:$seo->brands_meta_title_ar):$configration->app_name),
                'author' => new Thing('author', [
                    'name'=>$configration->app_name,
                    'url'=> \LaravelLocalization::localizeUrl("/brands"),
                ]),
    ...
    public function branchesPageSeo(){
        ...
        $metatags
                ->title(($seo->branches_meta_title || $seo->branches_meta_title_ar)? (($lang == 'en')?$seo->branches_meta_title:$seo->branches_meta_title_ar):$configration->app_name)
                ->meta('title',($seo->branches_meta_title || $seo->branches_meta_title_ar)? (($lang == 'en')?$seo->branches_meta_title:$seo->branches_meta_title_ar):$configration->app_name)
                ->description(($seo->branches_meta_desc || $seo->branches_meta_desc_ar)?(($lang == 'en')?$seo->branches_meta_desc:$seo->branches_meta_desc_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
    ...
    public function inspectionRequestPageSeo(){
        ...
        $metatags
                ->title(($seo->inspectionRequest_meta_title || $seo->inspectionRequest_meta_title_ar)? (($lang == 'en')?$seo->inspectionRequest_meta_title:$seo->inspectionRequest_meta_title_ar):$configration->app_name)
                ->meta('title',($seo->inspectionRequest_meta_title || $seo->inspectionRequest_meta_title_ar)? (($lang == 'en')?$seo->inspectionRequest_meta_title:$seo->inspectionRequest_meta_title_ar):$configration->app_name)
                ->description(($seo->inspectionRequest_meta_desc || $seo->inspectionRequest_meta_desc_ar)?(($lang == 'en')?$seo->inspectionRequest_meta_desc:$seo->inspectionRequest_meta_desc_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
    ...
    public function categoriesPageSeo(){
        ...
        $metatags
                ...
                ->meta('title',($seo->categories_meta_title || $seo->categories_meta_title_ar)? (($lang == 'en')?$seo->categories_meta_title:$seo->categories_meta_title_ar):$configration->app_name)
                ->description(($seo->categories_meta_desc || $seo->categories_meta_desc_ar)?(($lang == 'en')?$seo->categories_meta_desc:$seo->categories_meta_desc_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
    ...
    public function productsPageSeo(){
        ...
        $metatags
                ->title(($seo->featuredProducts_meta_title || $seo->featuredProducts_meta_title_ar)? (($lang == 'en')?$seo->featuredProducts_meta_title:$seo->featuredProducts_meta_title_ar):$configration->app_name)
                ->meta('title',($seo->featuredProducts_meta_title || $seo->featuredProducts_meta_title_ar)? (($lang == 'en')?$seo->featuredProducts_meta_title:$seo->featuredProducts_meta_title_ar):$configration->app_name)
                ->description(($seo->featuredProducts_meta || $seo->featuredProducts_meta_ar)?(($lang == 'en')?$seo->featuredProducts_meta:$seo->featuredProducts_meta_ar) :strip_tags($configration->about_app))
                ->meta('author',$configration->app_name)
                ->image(url("uploads/settings/source/$configration->app_logo"))
                ->mobile(\LaravelLocalization::localizeUrl('/categories'))
                ->canonical(\LaravelLocalization::localizeUrl('/categories'))
